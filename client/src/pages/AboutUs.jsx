...
const AboutUs = () => {
  return (
    <div className="min-h-screen pt-16 bg-white dark:bg-gray-900 transition-colors duration-500">
      {/* Hero Section */}
      <section className="relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 rounded-full -translate-x-32 -translate-y-32 opacity-30"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-full translate-x-32 translate-y-32 opacity-30"></div>
        ...
        <div className="container mx-auto px-6 py-20 relative z-10">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto mb-8 animate-slide-up" style={{animationDelay: '0.2s'}}>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-white dark:bg-gray-900/50 relative overflow-hidden transition-colors duration-500">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button 
                  ...
                  className="bg-white dark:bg-gray-800 text-purple-600 dark:text-purple-400 border-2 border-purple-600 dark:border-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 text-lg px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105"
                >
                  Become a Partner
                </button>
              </div>
